...
public class IRSimulator {
    ...
    public static final int DEFAULT_HEAP_SIZE = 1024000;
     ...
     *         {@link Configuration#ABSTRACT_RET_PREFIX} index 1
     */
     ...
     * registers with
     * prefix {@link Configuration#ABSTRACT_ARG_PREFIX} and indices starting from 1.
     * The function
     ...
     *
     * @param name name of the function call
     * @param args arguments to the function call, which may include the pointer to
     *             the location of
     *             multiple results
     */
    ...
    public class ExecutionFrame {
        ...
        /**
         * return values from this frame. Only used if the IRReturn node(s) for this
         * function have
         * children.
         */
        ...
        public boolean advance() {
            ...
            if (ip != backupIP)
                /* A jump was performed */ return true;
     ...
     * single-word
     * values (e.g., to evaluate binary expressions). This also keeps track of
     * whether a value was
     * created by a TEMP or MEM, or NAME reference, which is useful when executing
     * moves.
     */
